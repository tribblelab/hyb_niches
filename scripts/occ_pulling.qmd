...
non_res_df = DataFrame(CSV.File("data/occurrence_data/supp_data/non_research_inat_formatted.csv"; missingstring=["", "NA"]))
...
CSV.write("data/occurrence_data/summarytables_plots/ranked_togeoref.csv", enoughobs)
```
